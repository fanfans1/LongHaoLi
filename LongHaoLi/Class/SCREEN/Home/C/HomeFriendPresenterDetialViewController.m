//
//  HomeFriendPresenterDetialViewController.m
//  LongHaoLi
//
...
@interface HomeFriendPresenterDetialViewController ()<UITableViewDelegate,UITableViewDataSource,HomeTicketDetialShopTableViewCellDelegate>
...
@implementation HomeFriendPresenterDetialViewController
...
- (void)pay{
    ISLOGIN;
    PayFriendOrderViewController *pay = [[PayFriendOrderViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //        if (indexPath.row == 0) {
    //            HomeTicketDetialHeadTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"head"];
    //            [cell.headImage sd_setImageWithURL:[NSURL URLWithString:[self.rollInfo.photo substringFromIndex:1]] placeholderImage:[UIImage imageNamed:@"loadingimg.png"] options:SDWebImageAllowInvalidSSLCertificates];
    //
    //            cell.selectionStyle = UITableViewCellSelectionStyleNone;
    //            return cell;
    //        }else{
    //            HomeTicketDetialTicketTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ticket"];
    //            cell.name.text = self.rollInfo.name;
    //            cell.desc.text = self.rollInfo.intro;
    //            cell.noPrice.text = [NSString stringWithFormat:@"%.1f",self.rollInfo.salePrice];
    //            cell.shopPrice.text = [NSString stringWithFormat:@"门市价%.1f元",self.rollInfo.originalPrice];
    //            cell.surplus.text = [NSString stringWithFormat:@"剩余:%d",self.rollInfo.surplusCount];
    //            cell.surplus.layer.masksToBounds = YES;
    //            cell.surplus.layer.borderWidth = 1;
    //            cell.surplus.layer.cornerRadius = 3;
    //            cell.surplus.layer.borderColor = BACKGROUNDCOLOR.CGColor;
    //            cell.selectionStyle = UITableViewCellSelectionStyleNone;
    //            return cell;
    //        }
    //    }else
