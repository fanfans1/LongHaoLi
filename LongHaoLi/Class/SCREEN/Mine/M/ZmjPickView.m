...
- (void)initView {
    ...
    _addressLb.text = _addressStr.length > 0? _addressStr : [NSString stringWithFormat:@"%@%@%@",_shengArray[0][@"name"],_shiArr.count > 0? _shiArr[0][@"name"]:0,_xianArr.count > 0? _xianArr[0][@"name"]:0];
}
...
- (void)determineBtnAction:(UIButton *)button {
    ...
    _addressStr = [NSString stringWithFormat:@"%@%@%@",_shengArray[shengRow][@"name"],
