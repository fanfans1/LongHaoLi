...
@interface TicketBuyViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)getMessage{
    ...
    NSString *str = [MyBase64 base64EncodingWithData:[MD5 md5: [NSString stringWithFormat:@"%@%@%@%@",[MD5 md5: time],[user objectForKey:@"id"],@"2",[NSString stringWithFormat:@"%d",_page]]]];
